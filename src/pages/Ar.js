    ...
    <section id="two" className="wrapper alt style2 arabic">
      <section className="spotlight">
        ...
        <div className="content">
          <h2>الخطوة 1:</h2>
          <p>
            الخطوة 1: أنشئ حسابًا وأضف بياناتك الشخصية (مؤهلك الدراسى ، الراتب ،
            الطول ، الوزن ، لون البشرة ، إلخ.)
          </p>
        </div>
      </section>
      <section className="spotlight">
      ...
      <section className="spotlight">
        ...
        <div className="content">
          <h2>الخطوه 3:</h2>
          <p>
            انتظر حتى تتطابق! سنقوم بتشغيل اولوياتك و بياناتك الشخصية من خلال
            قاعدة البيانات الخاصة بنا والعثور على الأشخاص الذين يستوفون اولوياتك
            وتلبية احتياجاتهم!
          </p>
        </div>
      </section>
      ...
      <section className="spotlight">
        ...
        <div className="content">
          <h2>الخطوة 4:</h2>
          <p>
            تلبية شريكك في المستقبل! بمجرد أن تتم المطابقة ، ستتم مشاركة معلومات
            الاتصال الخاصة بك مع شريكك المحتملة ويمكنك الاتصال واللقاء في الحياة
            الحقيقية للتعرف على بعضهما البعض.
          </p>
        </div>
      </section>
